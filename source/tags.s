/*******************************************************************************
* tags.s
* Reads the ARM Linux boot tags for information
* Dom Jackson's Pi OS
* @domjacko
*******************************************************************************/

/*
* Addresses of all tags detected, with 0 representing an undetected tag.
*/
.section .data
tag_core: .int 0
tag_mem: .int 0
...
/*
* Finds all the addresses of the tags and returns the address of the tag
* given in r0
*/
.section .text
.globl FindTag
